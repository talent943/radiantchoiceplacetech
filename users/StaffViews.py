...
from .models import CustomUser, Staff, Course, Subject, Student, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
...
def staff_apply_leave(request):
	print(request.user.id)
	staff_obj = Staffs.object.get(admin=request.user.id)
